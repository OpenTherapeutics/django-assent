# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-10 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_format', models.CharField(choices=[('MARK', 'Markdown format'), ('TEXT', 'Simple text format'), ('REST', 'ReStructured Text format'), ('HTML', 'HTML format')], default='TEXT', max_length=8, verbose_name='content format')),
