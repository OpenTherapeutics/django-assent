# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-10 01:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_format', models.CharField(choices=[('TEXT', 'Simple text format'), ('MARK', 'Markdown format'), ('HTML', 'HTML format'), ('REST', 'ReStructured Text format')], default='TEXT', max_length=8, verbose_name='content format')),
        ...
        migrations.AddField(
            ...
            name='latest_version',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='assent.AgreementVersion'),
        ),
    ]
